...
public class MainActivity extends AppCompatActivity {
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            Log.i(TAG, "[MainActivity] onServiceConnected  "+pidInfo);
    ...
    private void bindRemoteService(){
        Log.i(TAG, "[MainActivity] bindRemoteService");
    ...
    private void unbindRemoteService(){
        ...
        Log.i(TAG, "[MainActivity] unbindRemoteService ==>");
    ...
    private void killRemoteService(){
        Log.i(TAG, "[MainActivity] killRemoteService");
        try {
